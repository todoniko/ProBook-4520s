/*
  RSD PTR: OEM=HPQOEM, ACPI_Rev=2.0x (2)
	XSDT=0x00000000bf7fe120, length=36, cksum=157
 */
/*
  XSDT: Length=124, Revision=1, Checksum=237,
	OEMID=HPQOEM, OEM Table ID=SLIC-MPC, OEM Revision=0xf,
	Creator ID=, Creator Revision=0x1000013
	Entries={ 0x00000000bf7fc000, 0x00000000bf7fb000, 0x00000000bf7fa000, 0x00000000bf7f9000, 0x00000000bf7f8000, 0x00000000bf7d5000, 0x00000000bf7d4000, 0x00000000bf7d3000, 0x00000000bf7d2000, 0x00000000bf7d1000, 0x00000000bf7d0000 }
 */
/*
  FACP: Length=244, Revision=3, Checksum=176,
	OEMID=HPQOEM, OEM Table ID=1411, OEM Revision=0xf,
	Creator ID=HP, Creator Revision=0x1
 	FACS=0xbf77e000, DSDT=0xbf7d8000
	INT_MODEL=PIC
	...
	RESET_REG=0xcf9:0[8] (IO), RESET_VALUE=0x4
	X_FACS=0x00000000bf77e000, X_DSDT=0x00000000bf7d8000
 ...
 */
/*
  DSDT: Length=126390, Revision=2, Checksum=78,
	OEMID=HPQOEM, OEM Table ID=1411, OEM Revision=0x1,
 ...
 */
/*
  APIC: Length=188, Revision=1, Checksum=81,
	OEMID=HPQOEM, OEM Table ID=1411, OEM Revision=0x1,
	Creator ID=HP, Creator Revision=0x1
 ...
 */
/*
  ASF!: Length=160, Revision=32, Checksum=255,
	OEMID=HPQOEM, OEM Table ID=1411, OEM Revision=0x1,
	Creator ID=HP, Creator Revision=0x1
 */
/*
  SSDT: Length=309, Revision=1, Checksum=38,
	OEMID=HPQOEM, OEM Table ID=SataAhci, OEM Revision=0x1000,
	Creator ID=INTL, Creator Revision=0x20060912
 */
/*
  SSDT: Length=788, Revision=1, Checksum=77,
	OEMID=HPQOEM, OEM Table ID=PtidDevc, OEM Revision=0x1000,
	Creator ID=INTL, Creator Revision=0x20060912
 */
/*
  SSDT: Length=95, Revision=1, Checksum=187,
	OEMID=HPQOEM, OEM Table ID=HPQNLP, OEM Revision=0x1,
	Creator ID=INTL, Creator Revision=0x20060912
 */
/*
  SSDT: Length=2576, Revision=1, Checksum=213,
	OEMID=PmRef, OEM Table ID=CpuPm, OEM Revision=0x3000,
	Creator ID=INTL, Creator Revision=0x20060912
 */
/*
  SSDT: Length=648, Revision=1, Checksum=5,
	OEMID=PmRef, OEM Table ID=Cpu0Tst, OEM Revision=0x3000,
	Creator ID=INTL, Creator Revision=0x20060912
 */
/*
  SSDT: Length=549, Revision=1, Checksum=30,
 ...
 *
 * Disassembly of /tmp/acpidump.eWLicY, Fri Nov 13 14:23:07 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00020043 (131139)
 *     Revision         0x02
 *     Checksum         0x79
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "1411    "
 ...
 */
DefinitionBlock ("/tmp/acpidump.aml", "DSDT", 2, "HPQOEM", "1411    ", 0x00000001)
{
    /*
    ...
    OperationRegion (GNVS, SystemMemory, 0xBF784918, 0x0172)
    ...
    OperationRegion (ASMA, SystemMemory, 0xBF780018, 0x1060)
    Field (ASMA, AnyAcc, NoLock, Preserve)
    {
        ASMB,   33536
    }

    OperationRegion (AF10, SystemMemory, 0xBF782018, 0x08BF)
    ...
    OperationRegion (HPDF, SystemMemory, 0xBF783E18, 0x0163)
    ...
    OperationRegion (HPD2, SystemMemory, 0xBF6CAF18, 0x0058)
    ...
    OperationRegion (HPBR, SystemMemory, 0xBF77FF18, 0x007E)
    ...
    Scope (\_TZ)
    {
        ...
        Name (WHTR, 0x09)
        Name (OSTH, 0x00)
        Name (LARE, Package (0x0A) {})
        Name (LARP, Package (0x0A) {})
        Name (CUZO, Package (0x0A) {})
        Mutex (THER, 0x00)
        Name (THSC, 0x39)
        Name (MIFA, 0x00) // Minimal FAN Speed
        Name (VGGT, 0x00)
        Name (VGST, 0x00)
        Name (LVTK, 0x00)
        Name (LVTC, 0x00)
        ...
        Method (RETD, 0, Serialized)
        {
            ...
            While ((Local0 < 0x0A))
            {
                Index (LARE, Local0) = 0x00
                Index (LARP, Local0) = 0x00
                Index (CUZO, Local0) = 0xFF
                Local0++
            }
        ...
        Method (GETP, 2, Serialized)
        {
            Local0 = 0x01
            Local1 = Arg0
            Local3 = DerefOf (Index (CUZO, Arg1))
            If ((Local3 == 0xFF))
            {
                Local3 = 0x00
            }
            ...
            Local2 = DerefOf (Index (DerefOf (Index (DerefOf (Index (TRIP, CATZ (Arg1))), 
                Local0)), Local1))
            Return (Local2)
        }

        Method (GTTP, 4, Serialized)
        {
            If ((Arg0 == 0x05))
            {
                Local1 = Arg1
            ...
            Else
            {
                If ((Arg0 < 0x04))
                {
                    Local2 = \_SB.PCI0.LPCB.SMAB (0x99, Arg1, 0x00)
                    If ((Local2 & 0xFF00))
                    {
                        Local2 = 0x00
                    }
            ...
            If ((Local1 < Arg2))
            {
                If ((DerefOf (Index (LARE, Arg0)) < Arg2))
                {
                    Index (LARP, Arg0) = Arg2
                }

                Local1 = DerefOf (Index (LARP, Arg0))
            }
            Else
            {
                If ((Local1 > Arg3))
                {
                    If ((DerefOf (Index (LARE, Arg0)) > Arg3))
                    {
                        Index (LARP, Arg0) = Arg3
                    }
            ...
            Index (LARE, Arg0) = Local2
            Index (LARP, Arg0) = Local1
            Return (Local1)
        }

        Method (SETM, 4, Serialized)
        {
            Local5 = 0x00
            Acquire (THER, 0xFFFF)
            Local7 = (0x01 << Arg0)
            If ((THSC & Local7))
            {
                If ((WHTR & Local7))
                {
                    Local0 = Match (DerefOf (Index (DerefOf (Index (TRIP, CATZ (Arg0))), 0x01
                        )), MGT, Arg1, MTR, 0x00, 0x00)
                }
                Else
                {
                    Local0 = Match (DerefOf (Index (DerefOf (Index (TRIP, CATZ (Arg0))), 0x00
                        )), MGE, Arg1, MTR, 0x00, 0x00)
                    Local0--
                    WHTR |= Local7
                }

                Local3 = DerefOf (Index (DerefOf (Index (TRIP, CATZ (Arg0))), 0x01))
                Local4 = SizeOf (Local3)
                If ((((Local0 != DerefOf (Index (CUZO, Arg0))) || SCPC) && 
                    (Local0 < Local4)))
                {
                    Local5 = 0x01
                    SCPC = 0x00
                    Index (CUZO, Arg0) = Local0
                    Local4 = DerefOf (Index (DerefOf (Index (DerefOf (Index (TRIP, CATZ (Arg0))), 
                        0x01)), Local0))
                    Local4 -= 0x0AAC
                    Divide (Local4, 0x0A, Local1, Local6)
                    Local4 = DerefOf (Index (DerefOf (Index (DerefOf (Index (TRIP, CATZ (Arg0))), 
                        0x00)), Local0))
                    If ((Local4 < 0x0AAC))
                    {
                        Local1 = (0x0AAC - Local4)
                    ...
                    {
                        Local4 -= 0x0AAC
                        Divide (Local4, 0x0A, Local1, Local2)
                    }

                    If ((Arg0 < 0x04))
                    {
                        \_SB.PCI0.LPCB.SMAB (0x98, Arg2, Local2)
                        \_SB.PCI0.LPCB.SMAB (0x98, Arg3, Local6)
                    }
                    Else
                    {
                        If ((Arg0 == 0x04))
        ...
        ThermalZone (EXTZ)
        {
            ...
            {
                \_TZ.OSIT ()
                Local0 = GTTP (0x00, 0x01, 0x0AAC, 0x0FA2)
                If (SETM (0x00, Local0, 0x0E, 0x0D))
                {
                    Notify (\_TZ.EXTZ, 0x81) // Thermal Trip Point Change
                }
        ...
        ThermalZone (LOCZ)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                Local0 = GTTP (0x03, 0x00, 0x0AAC, 0x0FA2)
                If (SETM (0x03, Local0, 0x0C, 0x0B))
                {
                    Notify (\_TZ.LOCZ, 0x81) // Thermal Trip Point Change
                }
        ...
        ThermalZone (GFXZ)
        {
            Method (_CRT, 0, Serialized)  // _CRT: Critical Temperature
            {
                Return (GETP (0x00, 0x04))
            }

            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                Local3 = VGGT /* \_TZ_.VGGT */
                Local0 = GTTP (0x04, Local3, 0x0AAC, 0x0FA2)
                LVTK = Local0
                LVTC = VGGT /* \_TZ_.VGGT */
                If (SETM (0x04, Local0, 0x00, 0x00))
                {
        ...
        ThermalZone (BATZ)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                ...
                If (\_SB.PCI0.LPCB.EC0.ECRG)
                {
                    Local1 = \_SB.PCI0.LPCB.EC0.CBT
                }

                Release (\_SB.PCI0.LPCB.EC0.ECMX)
                Local0 = GTTP (0x05, Local1, 0x0AAC, 0x0FA2)
                If (SETM (0x05, Local0, 0x00, 0x00))
                {
        ...
        ThermalZone (EGXZ)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                ...
                If (\_SB.PCI0.LPCB.EC0.ECRG)
                {
                    \_SB.PCI0.LPCB.EC0.CRZN = 0x02
                    Local1 = \_SB.PCI0.LPCB.EC0.TEMP
                }

                Release (\_SB.PCI0.LPCB.EC0.ECMX)
                Local0 = GTTP (0x06, Local1, 0x0AAC, 0x0FA2)
                Return (Local0)
            }
        }
        ...
        ThermalZone (CPUZ)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                ...
                Local2 = CTV1 /* \CTV1 */
                Local1 = (Local2 >> 0x06)
                Local0 = GTTP (0x07, Local1, 0x0AAC, 0x0FA2)
                Return (Local0)
            }
        }
        ...
        ThermalZone (MCHZ)
        {
            ...
            {
                Local0 = 0x0AAC
                Local0 = GTTP (0x08, MCHT, 0x0AAC, 0x0FA2)
                Return (Local0)
            }
        }
        ...
        ThermalZone (PCHZ)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                Local0 = GTTP (0x09, PCHT, 0x0AAC, 0x0FA2)
                Return (Local0)
            }
        }
        ...
        Method (NTHS, 1, Serialized)
        {
            ...
            If ((Arg0 & 0x02))
            {
                Notify (EX2Z, 0x80) // Thermal Status Change
            }

            If ((Arg0 & 0x04))
            {
                Notify (PWMZ, 0x80) // Thermal Status Change
            }
            ...
            If ((Arg0 & 0x40))
            {
                Notify (EGXZ, 0x80) // Thermal Status Change
            }
            ...
            If ((Arg0 & 0x0100))
            {
                Notify (MCHZ, 0x80) // Thermal Status Change
            }

            If ((Arg0 & 0x0200))
            {
                Notify (PCHZ, 0x80) // Thermal Status Change
            }
        }
        ...
        Method (INTS, 2, Serialized)
        {
            ...
            {
                Local2 = Arg0
                \_SB.PCI0.LPCB.SMAB (0x98, 0x19, Local2)
            }

            If (Arg1)
            {
                Local2 = Arg1
                \_SB.PCI0.LPCB.SMAB (0x98, 0x20, Local2)
            }

            Local3 = ~0x00
            Local2 = (Local3 & 0x03)
            \_SB.PCI0.LPCB.SMAB (0x98, 0x1F, Local2)
            \_SB.PCI0.LPCB.SMAB (0x98, 0x0A, 0x04)
            \_SB.PCI0.LPCB.SMAB (0x98, 0x09, 0x00)
            \_SB.PCI0.LPCB.SMAB (0x98, 0x21, 0x0A)
        }

        Method (THEV, 0, Serialized)
        {
            Local0 = \_SB.PCI0.LPCB.SMAB (0x19, 0x00, 0x00)
            Local1 = 0x00
            Local3 = 0x09
            Local0 = \_SB.PCI0.LPCB.SMAB (0x99, 0x02, 0x00)
    ...
    Method (\ISTR, 2, NotSerialized)
    {
        ...
        {
            Local1 = (Local0 & 0x0F)
            Local2 = DerefOf (Index (\NIST, Local1))
    ...
    Method (\SRCP, 2, NotSerialized)
    {
        ...
        {
            Local2 = DerefOf (Index (ST00, Local6))
            Local3 = DerefOf (Index (ST01, Local6))
            Local6++
            If ((Local2 != Local3))
            {
                Local0 = 0x00
    ...
    Method (WCOS, 0, Serialized)
    {
        If ((WOSI == 0xFF))
        {
            ...
            {
                Local2 = \SRCP (Local0, DerefOf (Index (OSID, Local1)))
                If (Local2)
                {
                    WOSI = (Local1 + 0x01)
                }
    ...
    Method (UPRW, 2, Serialized)
    {
        ...
        Index (Local0, 0x00) = Arg0
        If ((UWKD == 0x00))
        {
            Index (Local0, 0x01) = Arg1
        }
    ...
    Method (CBRT, 2, Serialized)
    {
        ...
        {
            Index (Local0, Local1) = DerefOf (Index (Arg0, Local1))
            Local1++
        }
        ...
        {
            Index (Local0, Local1) = DerefOf (Index (Arg1, Local2))
            Local1++
            Local2++
        }
    ...
    Scope (\_SB)
    {
        Device (PCI0)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                Local0 = (\_SB.CPBG.IMCH.PXBR << 0x14)
                M1MX = (Local0 - 0x01)
                M1LN = ((M1MX - M1MN) + 0x01)
                ...
                Local1 = (0x10000000 >> \_SB.CPBG.IMCH.PXSZ)
                M2MN = (Local0 + Local1)
                M2LN = ((M2MX - M2MN) + 0x01)
            ...
            Device (PDRC)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    {
                        CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y11._LEN, MBLN)  // _LEN: Length
                        MBLN = Zero
                    }
                    Else
                    {
                    ...
                    {
                        CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y13._LEN, EBLN)  // _LEN: Length
                        EBLN = Zero
                    }
                    Else
                    {
            ...
            Device (GFX0)
            {
                ...
                Method (_DOD, 0, NotSerialized)  // _DOD: Display Output Devices
                {
                    If ((DODC == 0x00))
                    {
                        ...
                        If ((NDID == 0x00))
                        {
                            Index (DerefOf (Index (DODS, NDID)), 0x00) = 0x0400
                        }

                        If ((NDID == 0x01))
                        {
                            Index (DerefOf (Index (DODS, NDID)), 0x00) = (0x00010000 | DID1
                                )
                        }
                        ...
                        If ((NDID == 0x02))
                        {
                            ...
                            Index (DerefOf (Index (DODS, NDID)), 0x01) = (0x00010000 | DID2
                                )
                        }
                        ...
                        If ((NDID == 0x03))
                        {
                            ...
                            Index (DerefOf (Index (DODS, NDID)), 0x02) = (0x00010000 | DID3
                                )
                        }
                        ...
                        If ((NDID == 0x04))
                        {
                            ...
                            Index (DerefOf (Index (DODS, NDID)), 0x03) = (0x00010000 | DID4
                                )
                        }
                        ...
                        If ((NDID == 0x05))
                        {
                            ...
                            Index (DerefOf (Index (DODS, NDID)), 0x04) = (0x00010000 | DID5
                                )
                        }
                        ...
                        If ((NDID == 0x06))
                        {
                            ...
                            Index (DerefOf (Index (DODS, NDID)), 0x05) = (0x00010000 | DID6
                                )
                        }
                        ...
                        If ((NDID == 0x07))
                        {
                            ...
                            Index (DerefOf (Index (DODS, NDID)), 0x06) = (0x00010000 | DID7
                                )
                        }
                        ...
                        If ((NDID == 0x08))
                        {
                            ...
                            Index (DerefOf (Index (DODS, NDID)), 0x07) = (0x00010000 | DID8
                                )
                        }
                    }
            ...
            Scope (GFX0)
            {
                ...
                Method (THPM, 1, NotSerialized)
                {
                    Local0 = (Arg0 & 0x0F0F)
                    Local1 = Match (HPDD, MEQ, Local0, MTR, 0x00, 0x00)
                    If ((Local1 == Ones))
                    {
                        Local2 = 0x00
                    }
                ...
                Method (SBRV, 0, Serialized)
                {
                    ...
                    If (Local3)
                    {
                        ...
                        Local2 = BRLV /* \BRLV */
                        Local5 = BMAP /* \BMAP */
                        Debug = "Brightness Data"
                        Debug = Local2
                        If ((BRCT == 0x0B))
                        {
                            Local0 = DerefOf (Index (Local5, Local0))
                        }

                        Local1 = DerefOf (Index (Local2, Local0))
                        Debug = Local1
                        AINT (0x01, Local1)
                    }
                ...
                Scope (DD02)
                {
                    ...
                    Method (_BCM, 1, Serialized)  // _BCM: Brightness Control Method
                    {
                        ...
                        BRIG = Arg0
                        Local1 = Match (DerefOf (Index (\_SB.BCLS, \_SB.BCLI)), MGE, Arg0, MTR, 0x00, 
                            0x02)
                        If ((Local1 == Ones))
                        {
                            Local1 = (SizeOf (DerefOf (Index (\_SB.BCLS, \_SB.BCLI))) - 0x01)
                        }
                    ...
                    {
                        Local0 = BRIG /* \_SB_.PCI0.GFX0.DD02.BRIG */
                        Return (Local0)
                    }
                }
                ...
                Scope (\_GPE)
                {
                    ...
                    Method (VLET, 0, Serialized)
                    {
                        ...
                        {
                            Local1 = 0x01
                            If ((\_SB.PCI0.PEGP.DGFX.VVID == 0x10DE))
                            {
                                If (((WDPE & 0x03) == 0x00))
                                {
                                    If ((\WCOS () < 0x06))
                    ...
                    Method (VPUP, 2, Serialized)
                    {
                        ...
                        Else
                        {
                            Local0 = ((Arg1 << 0x08) | Arg0)
                            \_SB.SSMI (0xEA74, 0x07, Local0, 0x00, 0x00)
                        }
                    }
                }
                    ...
                    Method (VSDD, 1, Serialized)
                    {
                        ...
                        Else
                        {
                            ...
                            Else
                            {
                                ...
                                {
                                    WDSS = (Arg0 & WDST) /* \WDST */
                                    \_SB.SSMI (0xEA74, 0x01, 0x00, 0x00, 0x00)
                                }
                            }
                        }
                    }
                    ...
                    Method (VWAK, 1, Serialized)
                    {
                        If ((\_SB.PCI0.GFX0.GIVD == 0x00))
                        {
                            ...
                            If ((Arg0 >= 0x03))
                            {
                                ...
                                If ((BRCT == 0x0B))
                                {
                                    Local1 = DerefOf (Index (Local3, Local1))
                                }
            ...
            Device (PEGP.DGFX)
            {
                ...
                Method (_DOD, 0, NotSerialized)  // _DOD: Display Output Devices
                {
                    ...
                    Index (DODS, 0x00) = (0x00010000 | DerefOf (Index (DIDX, 0x01)))
                    Index (DODS, 0x01) = (0x00010000 | DerefOf (Index (DIDX, 0x00)))
                    Index (DODS, 0x02) = (0x00010000 | DerefOf (Index (DIDX, 0x03)))
                    Index (DODS, 0x03) = (0x00010000 | DerefOf (Index (DIDX, 0x04)))
                    Index (DODS, 0x04) = (0x00010000 | DerefOf (Index (DIDX, 0x05)))
                ...
                Method (_REG, 2, NotSerialized)  // _REG: Region Availability
                {
                    ...
                    If (((Arg0 == 0x02) && (Arg1 == 0x01)))
                    {
                        If ((\WCOS () < 0x06))
                        {
                            \_SB.SSMI (0xEA74, 0x05, 0x01, 0x00, 0x00)
                        }
                    }
                }
                ...
                Device (LCD)
                {
                    ...
                    Method (_BQC, 0, Serialized)  // _BQC: Brightness Query Current
                    {
                        Local0 = BRIG /* \_SB_.PCI0.PEGP.DGFX.LCD_.BRIG */
                        Return (Local0)
                    }
                }
                ...
                Scope (\_SB)
                {
                        ...
                        If ((BCLC == 0x00))
                        {
                            ...
                            If ((DCAP & 0x10))
                            {
                                ...
                                While ((Local1 < BRCT))
                                {
                                    ...
                                    Else
                                    {
                                        Local3 = DerefOf (Index (Local4, Local1))
                                    }

                                    Local2 = DerefOf (Index (Local0, Local3))
                                    Local3 = (Local2 * 0x64)
                                    Divide ((Local3 + 0x7F), 0xFF, Local6, Local2)
                                    Index (DerefOf (Index (BCLS, BCLI)), (Local1 + 0x02)) = 
                                        Local2
                                    If ((Local2 > Local5))
                                    {
                                        Local5 = Local2
                                ...
                                Local3 = (BRCT >> 0x01)
                                Index (DerefOf (Index (BCLS, BCLI)), 0x01) = DerefOf (Index (DerefOf (
                                    Index (BCLS, BCLI)), Local3))
                                Index (DerefOf (Index (BCLS, BCLI)), 0x00) = Local5
                            }
                            Else
                            {
                                Local4 = BCLV /* \BCLV */
                                ...
                                While ((Local1 < (BRCT + 0x02)))
                                {
                                    ...
                                    Else
                                    {
                                        Local3 = DerefOf (Index (Local0, (Local1 - 0x02)))
                                        Local3 += 0x02
                                    }

                                    Local2 = DerefOf (Index (Local4, Local3))
                                    Index (DerefOf (Index (BCLS, BCLI)), Local1) = Local2
                                    Local1++
                                }
                            }
                            ...
                            While ((Local2 < BRCT))
                            {
                                ...
                                Else
                                {
                                    Local3 = DerefOf (Index (Local1, Local2))
                                }

                                Local3 <<= 0x01
                                Local5 = (Local2 << 0x01)
                                Local4 = DerefOf (Index (Local0, Local3))
                                Index (DerefOf (Index (NITS, BCLI)), Local5) = Local4
                                Local4 = DerefOf (Index (Local0, (Local3 + 0x01)))
                                Index (DerefOf (Index (NITS, BCLI)), (Local5 + 0x01)) = 
                                    Local4
                                Local2++
                            }
                    ...
                    Method (HDDC, 1, Serialized)
                    {
                        ...
                        Else
                        {
                            ...
                            While ((Local2 < Local0))
                            {
                                Index (Local1, Local2) = DerefOf (Index (Local3, Local2))
                                Local2++
                            }
                        }
                ...
                Method (ADR, 1, Serialized)
                {
                    ...
                    If ((Arg0 < Local2))
                    {
                        Local0 = DerefOf (Index (Local1, Arg0))
                        If ((\WCOS () < 0x06))
                        {
                            Local0 &= 0xFFFF
                        }
            ...
            Device (HDEF)
            {
                ...
                OperationRegion (HBAR, PCI_Config, 0x10, 0x04)
                Field (HBAR, WordAcc, NoLock, Preserve)
                {
                    BAR,    32
                }
            ...
            Device (LPCB)
            {
                ...
                Device (EC0)
                {
                    ...
                    /* Set Constant FAN speed while on power */
                    ...
                    /* Set Fan Speed Decimal */
                    /* Lower values = faster spin */
                    /* Range [0-99] */
                    Method (SFSD, 1, Serialized)
                    {
                        ...
                        PWM0 = Local1 // Pulse-width modulation
                    }
                    ...
                    Method (GCTL, 1, Serialized)
                    {
                        ...
                        While ((Local3 != 0x10))
                        {
                            Index (CTBF, Local2) = CTLB /* \_SB_.PCI0.LPCB.EC0_.CTLB */
                            Local2++
                            Local3++
                        }
                    ...
                    Method (BTIF, 1, Serialized)
                    {
                        ...
                        Index (NBST, Arg0) = NDBS /* \_SB_.NDBS */
                        Acquire (BTMX, 0xFFFF)
                        NGBT |= Local7
                        Release (BTMX)
                        Acquire (ECMX, 0xFFFF)
                        If (ECRG)
                        {
                            ...
                            Index (DerefOf (Index (NBTI, Arg0)), 0x01) = Local0
                            Index (DerefOf (Index (NBTI, Arg0)), 0x02) = Local0
                            Index (DerefOf (Index (NBTI, Arg0)), 0x04) = BDV /* \_SB_.PCI0.LPCB.EC0_.BDV_ */
                            Index (DerefOf (Index (NBTI, Arg0)), 0x05) = NLB1 /* \_SB_.PCI0.LPCB.EC0_.NLB1 */
                            Index (DerefOf (Index (NBTI, Arg0)), 0x06) = NLB2 /* \_SB_.PCI0.LPCB.EC0_.NLB2 */
                        ...
                        Index (DerefOf (Index (NBTI, Arg0)), 0x0A) = Local2
                        Acquire (BTMX, 0xFFFF)
                        NGBF &= ~Local7
                        Release (BTMX)
                        Return (0x00)
                    ...
                    Method (BTST, 2, Serialized)
                    {
                        ...
                        If (ECRG)
                        {
                            ...
                            Index (DerefOf (Index (NBST, Arg0)), 0x02) = BRC /* \_SB_.PCI0.LPCB.EC0_.BRC_ */
                            Index (DerefOf (Index (NBST, Arg0)), 0x03) = BPV /* \_SB_.PCI0.LPCB.EC0_.BPV_ */
                        }
                        ...
                        Index (DerefOf (Index (NBST, Arg0)), 0x00) = Local0
                        If ((Local0 & 0x01))
                        {
                            If (((Local3 < 0x0190) || (Local3 > 0x1964)))
                            {
                                Local5 = DerefOf (Index (DerefOf (Index (NBST, Arg0)), 0x01))
                        ...
                        Index (DerefOf (Index (NBST, Arg0)), 0x01) = Local3
                        Acquire (BTMX, 0xFFFF)
                        NGBT &= ~Local7
                        Release (BTMX)
                        Return (0x00)
                    ...
                    Method (GBTI, 1, NotSerialized)
                    {
                        ...
                        If (ECRG)
                        {
                            If ((BATP & (0x01 << Arg0)))
                            {
                                ...
                                Index (DerefOf (Index (Local0, 0x02)), 0x00) = BDC /* \_SB_.PCI0.LPCB.EC0_.BDC_ */
                                Index (DerefOf (Index (Local0, 0x02)), 0x01) = (BDC >> 0x08
                                    )
                                Index (DerefOf (Index (Local0, 0x02)), 0x02) = BFC /* \_SB_.PCI0.LPCB.EC0_.BFC_ */
                                Index (DerefOf (Index (Local0, 0x02)), 0x03) = (BFC >> 0x08
                                    )
                                Index (DerefOf (Index (Local0, 0x02)), 0x04) = BRC /* \_SB_.PCI0.LPCB.EC0_.BRC_ */
                                Index (DerefOf (Index (Local0, 0x02)), 0x05) = (BRC >> 0x08
                                    )
                                Index (DerefOf (Index (Local0, 0x02)), 0x06) = BME /* \_SB_.PCI0.LPCB.EC0_.BME_ */
                                Index (DerefOf (Index (Local0, 0x02)), 0x07) = (BME >> 0x08
                                    )
                                Index (DerefOf (Index (Local0, 0x02)), 0x08) = BCC /* \_SB_.PCI0.LPCB.EC0_.BCC_ */
                                Index (DerefOf (Index (Local0, 0x02)), 0x09) = (BCC >> 0x08
                                    )
                                Local1 = CBT /* \_SB_.PCI0.LPCB.EC0_.CBT_ */
                                Local1 -= 0x0AAC
                                Divide (Local1, 0x0A, Local2, Local3)
                                Index (DerefOf (Index (Local0, 0x02)), 0x0A) = Local3
                                Index (DerefOf (Index (Local0, 0x02)), 0x0B) = (Local3 >> 0x08
                                    )
                                Index (DerefOf (Index (Local0, 0x02)), 0x0C) = BPV /* \_SB_.PCI0.LPCB.EC0_.BPV_ */
                                Index (DerefOf (Index (Local0, 0x02)), 0x0D) = (BPV >> 0x08
                                    )
                                ...
                                Index (DerefOf (Index (Local0, 0x02)), 0x0E) = Local1
                                Index (DerefOf (Index (Local0, 0x02)), 0x0F) = (Local1 >> 0x08
                                    )
                                Index (DerefOf (Index (Local0, 0x02)), 0x10) = BDV /* \_SB_.PCI0.LPCB.EC0_.BDV_ */
                                Index (DerefOf (Index (Local0, 0x02)), 0x11) = (BDV >> 0x08
                                    )
                                Index (DerefOf (Index (Local0, 0x02)), 0x12) = BSTS /* \_SB_.PCI0.LPCB.EC0_.BSTS */
                                Index (DerefOf (Index (Local0, 0x02)), 0x13) = (BSTS >> 0x08
                                    )
                                Index (DerefOf (Index (Local0, 0x02)), 0x14) = BCV1 /* \_SB_.PCI0.LPCB.EC0_.BCV1 */
                                Index (DerefOf (Index (Local0, 0x02)), 0x15) = (BCV1 >> 0x08
                                    )
                                Index (DerefOf (Index (Local0, 0x02)), 0x16) = BCV2 /* \_SB_.PCI0.LPCB.EC0_.BCV2 */
                                Index (DerefOf (Index (Local0, 0x02)), 0x17) = (BCV2 >> 0x08
                                    )
                                Index (DerefOf (Index (Local0, 0x02)), 0x18) = BCV3 /* \_SB_.PCI0.LPCB.EC0_.BCV3 */
                                Index (DerefOf (Index (Local0, 0x02)), 0x19) = (BCV3 >> 0x08
                                    )
                                Index (DerefOf (Index (Local0, 0x02)), 0x1A) = BCV4 /* \_SB_.PCI0.LPCB.EC0_.BCV4 */
                                Index (DerefOf (Index (Local0, 0x02)), 0x1B) = (BCV4 >> 0x08
                                    )
                                CreateField (DerefOf (Index (Local0, 0x02)), (0x1C * 0x08), (0x10 * 
                                    0x08), BTSN)
                                BTSN = GBSS (BSN, BDAT)
                                Local1 = GBMF ()
                                Local2 = SizeOf (Local1)
                                CreateField (DerefOf (Index (Local0, 0x02)), (0x2C * 0x08), (Local2 * 
                                    0x08), BMAN)
                                BMAN = Local1
                                Local2 += 0x2C
                                CreateField (DerefOf (Index (Local0, 0x02)), (Local2 * 0x08), (0x10 * 
                                    0x08), CLBL)
                                CLBL = GCTL (0x00)
                            }
                            Else
                    ...
                    Method (GBTC, 0, NotSerialized)
                    {
                        ...
                        If (ECRG)
                        {
                            ...
                            {
                                BSEL = 0x00
                                Index (DerefOf (Index (Local0, 0x02)), 0x00) = 0x00
                                If ((BST & 0x01))
                                {
                                    Index (DerefOf (Index (Local0, 0x02)), 0x00) = 0x02
                                }

                                If ((BST & 0x02))
                                {
                                    Index (DerefOf (Index (Local0, 0x02)), 0x00) = 0x01
                                }

                                If ((BST & 0x04))
                                {
                                    Index (DerefOf (Index (Local0, 0x02)), 0x00) = 0x0E
                                }
                            }
                            Else
                            {
                                Index (DerefOf (Index (Local0, 0x02)), 0x00) = 0xFF
                            }

                            If ((BATP & 0x02))
                            {
                                BSEL = 0x01
                                Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x00
                                If ((BST & 0x01))
                                {
                                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x02
                                }

                                If ((BST & 0x02))
                                {
                                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x01
                                }

                                If ((BST & 0x04))
                                {
                                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x0E
                                }
                            }
                            Else
                            {
                                Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0xFF
                            }
                        }
                        Else
                        {
                    ...
                    Method (SBTC, 3, NotSerialized)
                    {
                        ...
                        If (ECRG)
                        {
                            ...
                            Local1 = 0x00
                            Local2 = 0x00
                            Local1 = DerefOf (Index (Local0, 0x10))
                            If ((Local1 == 0x00))
                            {
                                Debug = "battery 0"
                                If ((BATP & 0x01))
                                {
                                    Local2 = DerefOf (Index (Local0, 0x11))
                                    If ((Local2 == 0x00))
                                    {
                                        INCH = 0x00
                                        IDIS = 0x00
                ...
                Device (GTPM)
                {
                    ...
                    Method (HPPI, 4, NotSerialized)
                    {
                        ...
                        If ((Arg2 <= 0x06))
                        {
                            ...
                            If ((Arg2 == 0x02))
                            {
                                Local0 = DerefOf (Index (Arg3, 0x00))
                                Debug = "TPM Func 2"
                                Debug = Local0
                                If ((Local0 <= 0x0E))
                                {
                            ...
                            If ((Arg2 == 0x03))
                            {
                                ...
                                If ((EBX == 0x00))
                                {
                                    Index (DSMB, 0x00) = 0x00
                                    Index (DSMB, 0x01) = 0x00
                                    Local0 = ECX /* \ECX_ */
                                    If ((Local0 <= 0x0E))
                                    {
                                        Index (DSMB, 0x00) = 0x00
                                        Index (DSMB, 0x01) = Local0
                                    }
                                }
                            ...
                            If ((Arg2 == 0x05))
                            {
                                ...
                                If ((EBX == 0x00))
                                {
                                    Index (DSMC, 0x00) = 0x00
                                    Index (DSMC, 0x01) = ECX /* \ECX_ */
                                    \_SB.SSMI (0xEA7D, 0x02, 0x00, 0x00, 0x01)
                                    Index (DSMC, 0x02) = ECX /* \ECX_ */
                                }
                            ...
                            {
                                PPIB = Arg3
                                If ((((DerefOf (Index (PPIB, 0x00)) == 0x45) || (DerefOf (
                                    Index (PPIB, 0x00)) == 0x65)) && ((DerefOf (Index (PPIB, 0x01)) == 0x4E) || 
                                    (DerefOf (Index (PPIB, 0x01)) == 0x6E))))
                                {
                                    Return (0x00)
                                }
                                Else
                ...
                Device (SIO)
                {
                    ...
                    Method (GETR, 1, NotSerialized)
                    {
                        ...
                        Index (GRES, 0x00) = (Local0 << 0x02)
                        Index (GRES, 0x01) = (Local1 << 0x03)
                        Local4 = 0x00
                        If ((Local2 > 0x00))
                        {
                            Local4 = (0x01 << Local2)
                    ...
                    Method (DSOD, 1, Serialized)
                    {
                        ...
                        {
                            Local0 = GETR (Arg0)
                            Local1 = DerefOf (Index (Local0, 0x01))
                            Local2 = DerefOf (Index (Local0, 0x02))
                            Local3 = DerefOf (Index (Local0, 0x03))
                            Local4 = DerefOf (Index (Local0, 0x00))
                            Local3 |= (Local4 << 0x08)
                    ...
                    Device (HCOM)
                    {
                        ...
                        Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                        {
                            ...
                            Local1 = GETR (0x02)
                            MIN1 = DerefOf (Index (Local1, 0x00))
                    ...
                    Device (COM1)
                    {
                        ...
                        Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                        {
                            ...
                            IRQ0 = DerefOf (Index (Local1, 0x02))
                            Return (CRES) /* \_SB_.PCI0.LPCB.SIO_.COM1._CRS.CRES */
                        }
                    ...
                    Device (LPT0)
                    {
                        ...
                        Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                        {
                            ...
                            IRQ0 = DerefOf (Index (Local1, 0x02))
                            DMA0 = DerefOf (Index (Local1, 0x03))
                            Return (CRES) /* \_SB_.PCI0.LPCB.SIO_.LPT0._CRS.CRES */
                        }
                ...
                Device (PS2M)
                {
                    Name (_HID, EisaId ("SYN016A"))  // _HID: Hardware ID
            ...
            Device (ACEL)
            {
                ...
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    ...
                    {
                        Local0 = 0x0F
                        Local1 = \_SB.PCI0.LPCB.SMAB (0x3B, 0x20, 0x00)
                        If ((Local1 & 0xFF00))
                        {
                            Local0 = 0x00
                        }
                ...
                Method (ITAL, 0, Serialized)
                {
                    If (_STA ())
                    {
                        \_SB.PCI0.LPCB.SMAB (0x3A, 0x20, 0x47)
                        \_SB.PCI0.LPCB.SMAB (0x3A, 0x21, 0x0A)
                        \_SB.PCI0.LPCB.SMAB (0x3A, 0x32, 0x14)
                        \_SB.PCI0.LPCB.SMAB (0x3A, 0x33, 0x02)
                        \_SB.PCI0.LPCB.SMAB (0x3A, 0x30, 0x95)
                        Local0 = \_SB.PCI0.LPCB.SMAB (0x3B, 0x23, 0x00)
                        \_SB.PCI0.LPCB.SMAB (0x3A, 0x36, 0x11)
                        \_SB.PCI0.LPCB.SMAB (0x3A, 0x37, 0x01)
                        \_SB.PCI0.LPCB.SMAB (0x3A, 0x34, 0x2A)
                        CTST = 0xFF
                        AJAL ()
                    }
                }
                ...
                Method (AJAL, 0, Serialized)
                {
                    If (_STA ())
                    {
                        ...
                        If (((\_SB.LID._LID () == 0x00) && (Local0 == 0x00)))
                        {
                            ...
                            {
                                CTST = 0x01
                                \_SB.PCI0.LPCB.SMAB (0x3A, 0x22, 0x02)
                            }
                        }
                        Else
                        {
                            ...
                            {
                                CTST = 0x00
                                \_SB.PCI0.LPCB.SMAB (0x3A, 0x22, 0x01)
                            }
                        }
                    }
                }
                ...
                Method (CLRI, 0, Serialized)
                {
                    ...
                    If ((\_SB.PCI0.LPCB.EC0.GACS () == 0x00))
                    {
                        ...
                        {
                            Local0 = DerefOf (Index (DerefOf (Index (NBST, 0x00)), 0x00))
                        }

                        If ((\_SB.BAT1._STA () == 0x1F))
                        {
                            Local1 = DerefOf (Index (DerefOf (Index (NBST, 0x01)), 0x00))
                        }
                ...
                {
                    Local0 = \_SB.PCI0.LPCB.SMAB (0x3B, Arg0, 0x00)
                    Return (Local0)
                }

                Method (ALWR, 2, Serialized)
                {
                    Local0 = \_SB.PCI0.LPCB.SMAB (0x3A, Arg0, Arg1)
                    Return (Local0)
                }
        ...
        Scope (\_SB)
        {
            Device (CPBG)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    CreateWordField (BUF0, \_SB.CPBG._Y27._MIN, PBMN)  // _MIN: Minimum Base Address
                    PBMN = ((\PELN >> 0x14) - 0x01)
                    CreateWordField (BUF0, \_SB.CPBG._Y27._MAX, PBMX)  // _MAX: Maximum Base Address
                    PBMX = ((\PELN >> 0x14) - 0x01)
        ...
        Name (WSIP, Buffer (0x08)
        {
             0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF   /* ........ */
        })
        Name (SUIP, Buffer (0x02)
        {
             0xFF, 0xFF                                       /* .. */
        })
        Name (BSOL, Package (0x02)
        {
            ...
            {
                "Boot Order", 
                " Optical Disk Drive, Hard Drive(C:), USB Floppy, USB CD-ROM, USB Hard Disk, Network Controller, SD Card, eSATA, , , , , , , , ,", 
            ...
            {
                "UEFI Boot Order", 
                " Notebook Upgrade Bay(UEFI), OS Boot Manager, , , , , , , , , , , , , , ,", 
                "\\System Configuration\\Boot Options", 
                0x00, 
                0x01, 
                0x00, 
        ...
        Name (BISE, Package (0xAA)
        {
            ...
            Package (0x1A)
            {
                ...
                "SELECT * FROM HP_BIOSEnumeration WHERE Name=\'Embedded Security Device Availability\' AND CurrentValue=\'Hidden\'", 
                " ", 
                0x00, 
                "Disable", 
                0x0C, 
            ...
            Package (0x1A)
            {
                ...
                0x03, 
                "SELECT * FROM HP_BIOSPassword WHERE Name=\'Setup Password\' AND IsSet=1", 
                "SELECT * FROM HP_BIOSEnumeration WHERE Name=\'OS Management of TPM\' AND CurrentValue=\'Disable\'", 
                "SELECT * FROM HP_BIOSEnumeration WHERE Name=\'Embedded Security Device Availability\' AND CurrentValue=\'Hidden\'", 
                0x00, 
                "Disable", 
                0x0C, 
            ...
            Package (0x1A)
            {
                "Unconfigure AMT Security Level", 
                " View, Change, *Hide", 
                "\\System Configuration\\Security Level", 
                0x01, 
                0x00, 
        ...
        Device (WMID)
        {
            ...
            Method (WHCM, 2, NotSerialized)
            {
                ...
                If ((SNIN == 0x55434553))
                {
                    ...
                    If ((COMD == 0x01))
                    {
                        ...
                        If ((CMTP == 0x21))
                        {
                            If ((DASI < DerefOf (Index (WCDS, (CMTP - 0x01)))))
                            {
                                RTCD = 0x05
                            }
                            Else
                ...
                If ((RTCD == 0x00))
                {
                    RTCD = DerefOf (Index (Local2, 0x00))
                    If ((RTCD == 0x00))
                    {
                        ...
                        If ((Local3 <= Local0))
                        {
                            ...
                            While ((Local5 < Local3))
                            {
                                Index (Local1, (Local5 + 0x08)) = DerefOf (Index (DerefOf (Index (
                                    Local2, 0x02)), Local5))
                                Local5++
                            }
            ...
            Method (WFDA, 0, NotSerialized)
            {
                ...
                Index (Local0, 0x00) = EBX /* \EBX_ */
                If ((EBX == 0x00))
                {
                    Index (Local0, 0x01) = ECX /* \ECX_ */
                    If ((ECX != 0x00))
                    {
                        Local1 = ASMB /* \ASMB */
                        Local2 = 0x00
                        While ((Local2 < ECX))
                        {
                            Index (DerefOf (Index (Local0, 0x02)), Local2) = DerefOf (Index (Local1, 
                                Local2))
                            Local2++
                        }
                    }
            ...
            Method (HPMC, 1, NotSerialized)
            {
                Local0 = Buffer (0x80) {}
                Index (Local0, 0x00) = 0x01
                Index (Local0, 0x01) = 0x00
                If ((Arg0 == 0x00))
                {
                    CreateWordField (Local0, 0x04, SYSD)
                    CreateWordField (Local0, 0x06, SUPP)
                    CreateDWordField (Local0, 0x08, S0CP)
                    CreateDWordField (Local0, 0x0C, SXCP)
                    SYSD = 0x96
                    SUPP = 0x5F
                    S0CP = 0x78
                    SXCP = 0x07B8
                ...
                If ((Arg0 == 0x01))
                {
                    \_SB.SSMI (0xEA75, 0x00020003, Arg0, 0x574D4953, 0x00)
                    Local1 = ASMB /* \ASMB */
                    Local2 = 0x02
                    While ((Local2 < 0x09))
                    {
                        Index (Local0, Local2) = DerefOf (Index (Local1, Local2))
                        Local2++
                    }
                    ...
                    If ((PMCS == 0x01))
                    {
                        If (\_SB.PCI0.LPCB.EC0.ECRG)
                        {
                            ...
                            CreateWordField (Local0, 0x09, SYSS)
                            CreateDWordField (Local0, 0x0C, S0DR)
                            CreateDWordField (Local0, 0x0F, S0PW)
                            CreateDWordField (Local0, 0x13, S0CT)
                            CreateDWordField (Local0, 0x17, SXDR)
                            CreateDWordField (Local0, 0x1A, SXPW)
                            CreateDWordField (Local0, 0x1E, SXCT)
                            Local1 = \_SB.PCI0.LPCB.EC0.S0FL
                            Local2 = \_SB.PCI0.LPCB.EC0.SXFL
                            Local3 = 0x01
                            If (((Local1 & 0x10) == 0x00))
                            {
                                Local3 |= 0x02
                            ...
                            SYSS = Local3
                            S0DR = 0x00140000
                            S0DR |= ((Local1 & 0x0F) << 0x03) /* \_SB_.WMID.HPMC.S0DR */
                            Local3 = 0x00140000
                            Local3 |= ((Local2 & 0xF7) << 0x03)
                            If (((Local2 & 0x01) == 0x00))
                            {
                                Local3 |= 0x8000
                            }
                            ...
                            Else
                            {
                                S0PW = \_SB.PCI0.LPCB.EC0.S0PW
                                S0CT = \_SB.PCI0.LPCB.EC0.S0CT
                                Local3 = Package (0x04)
                                    {
                                        0xD2, 
                                        0xD2, 
                                ...
                                Local2 = ((Local2 >> 0x03) & 0x03)
                                Local4 = DerefOf (Index (Local3, Local2))
                                Local1 = \_SB.PCI0.LPCB.EC0.MOCT
                                Local2 = \_SB.PCI0.LPCB.EC0.M1CT
                                Local4 = ((Local1 * Local4) + (Local2 * 0xD2))
                                SXPW = (\_SB.PCI0.LPCB.EC0.SXPW + Local4)
                                SXCT = (\_SB.PCI0.LPCB.EC0.SXCT + (Local1 + Local2))
                            }
            ...
            Method (GBTT, 0, NotSerialized)
            {
                ...
                Index (Local0, 0x00) = 0x03
                Index (Local0, 0x01) = PNLF /* \PNLF */
                Index (Local0, 0x02) = 0x00
                Index (Local0, 0x03) = BRCT /* \BRCT */
                Local2 = 0x00
                Local3 = 0x04
                While ((Local2 < BRCT))
                {
                    Index (Local0, Local3) = DerefOf (Index (Local1, (Local2 + 0x02)
                        ))
                    Index (Local0, (Local3 + 0x01)) = 0x00
                    Local2++
                    Local3 += 0x02
                }

                Index (Local0, Local3) = 0x01
                Local3++
                Index (Local0, Local3) = BRCT /* \BRCT */
                Local3++
                Local2 = 0x00
                While ((Local2 < (BRCT * 0x02)))
                {
                    Index (Local0, Local3) = DerefOf (Index (DerefOf (Index (NITS, BCLI)), 
                        Local2))
                    Local2++
                    Local3++
                }

                Index (Local0, Local3) = 0x02
                Local3++
                Index (Local0, Local3) = 0x02
                Local3++
                Local2 = BPWG /* \BPWG */
                Index (Local0, Local3) = (Local2 & 0xFF)
                Local3++
                Index (Local0, Local3) = ((Local2 >> 0x08) & 0xFF)
                Local3++
                Local2 = BPWO /* \BPWO */
                Index (Local0, Local3) = (Local2 & 0xFF)
                Local3++
                ...
                Local3++
                Local2 = Package (0x03) {}
                Index (Local2, 0x00) = 0x00
                Index (Local2, 0x01) = Local5
                Index (Local2, 0x02) = Local0
                Return (Local2)
            }
            ...
            Method (GBTL, 1, NotSerialized)
            {
                ...
                If ((Arg0 == 0x00))
                {
                    Local2 = DerefOf (Index (Local1, (BRID + 0x02)))
                }
                Else
                {
                    If ((Arg0 == 0x01))
                    ...
                    Else
                    {
                        ...
                        {
                            Local4 = (BRID << 0x01)
                            Local2 = DerefOf (Index (DerefOf (Index (NITS, BCLI)), Local4))
                            Local3 = DerefOf (Index (DerefOf (Index (NITS, BCLI)), (Local4 + 0x01
                                )))
                        ...
                        Else
                        {
                            If ((Arg0 == 0x03))
                            {
                                ...
                                {
                                    Local2 = BMAP /* \BMAP */
                                    Local3 = DerefOf (Index (Local2, BRID))
                                }

                                Local2 = DerefOf (Index (Local1, Local3))
                            }
                            Else
                            {
                                Local0 = 0x06
                ...
                Local1 = Package (0x03) {}
                Index (Local1, 0x00) = Local0
                If ((Local0 == 0x00))
                {
                    Index (Local1, 0x01) = 0x04
                    Local3 = Buffer (0x04) {}
                    Index (Local3, 0x00) = (Local2 & 0xFF)
                    Index (Local3, 0x01) = ((Local2 >> 0x08) & 0xFF)
                    Index (Local1, 0x02) = Local3
                }
                Else
                {
                    Index (Local1, 0x01) = 0x00
                }
            ...
            Method (SBRT, 2, NotSerialized)
            {
                ...
                Else
                {
                    ...
                    Else
                    {
                        If ((Arg0 == 0x02))
                        {
                            Local2 = DerefOf (Index (NITS, BCLI))
                            Local3 = 0x00
                            While ((Local3 < BRCT))
                            {
                                If ((DerefOf (Index (Local2, (Local3 * 0x02))) == Arg1))
                                {
                                    Local1 = Local3
                                    Local3 = 0xFF
                                }
                        ...
                        Else
                        {
                            If ((Arg0 == 0x03))
                            {
                                ...
                                While ((Local4 < BRCT))
                                {
                                    ...
                                    If ((DerefOf (Index (Local2, Local5)) == Arg1))
                                    {
                                        Local1 = Local4
                                        Local4 = 0xFF
                                    }
            ...
            Method (WQBC, 1, NotSerialized)
            {
                ...
                If ((STAT == 0x80))
                {
                    Index (DerefOf (Index (BISE, Arg0)), 0x04) = 0x00
                }

                If ((FMOD == 0x01))
                {
                    Index (DerefOf (Index (BISE, Arg0)), 0x03) = 0x01
                    Index (DerefOf (Index (BISE, Arg0)), 0x04) = 0x00
                    Index (DerefOf (Index (BISE, Arg0)), 0x05) = 0x01
                    FMOD = 0x00
                }

                ST11 = DerefOf (Index (DerefOf (Index (BISE, Arg0)), 0x01))
                Local6 = SizeOf (ST11)
                Local3 = 0x00
                While ((Local3 != SizeOf (ST01)))
                {
                    Index (ST01, Local3) = 0x00
                    Local3++
                }

                Local3 = 0x01
                ST01 = DerefOf (Index (DerefOf (Index (BISE, Arg0)), 0x00))
                While ((Local4 != Local6))
                {
                    Local5 = DerefOf (Index (ST11, Local4))
                    If ((DerefOf (Index (ST11, Local4)) == 0x2C))
                    {
                        Local1++
                    }

                    If ((DerefOf (Index (ST11, Local4)) == 0x2A))
                    {
                        Index (ST11, Local4) = 0x20
                    }
                ...
                Debug = Local6
                Index (DerefOf (Index (BISE, Arg0)), 0x0B) = ((Local6 & 
                    0xF0) >> 0x04)
                Local6 = (Local6 & 0x0F)
                ...
                If ((Local1 == 0x01))
                {
                    If (\SRCM (ST01, "Internal Network Adapter Boot Mode", 0x22))
                    {
                        ...
                        If (Local6)
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = RPEN /* \_SB_.RPEN */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = RPL /* \_SB_.RPL_ */
                        }
                        Else
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = PXEN /* \_SB_.PXEN */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = PXE /* \_SB_.PXE_ */
                        }
                    }
                    ...
                    If (\SRCM (ST01, "Embedded Security Device Availability", 0x25))
                    {
                        ...
                        If (Local6)
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = TPMA /* \_SB_.TPMA */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = AVA /* \_SB_.AVA_ */
                        }
                        Else
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = TPMH /* \_SB_.TPMH */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = HID /* \_SB_.HID_ */
                        }
                    }
                    ...
                    If (\SRCM (ST01, "Terminal Emulation Mode", 0x17))
                    {
                        ...
                        If ((Local6 == 0x01))
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = SETV /* \_SB_.SETV */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = V100 /* \_SB_.V100 */
                        }
                        Else
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = SETA /* \_SB_.SETA */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = ANSI /* \_SB_.ANSI */
                        }
                    }
                    ...
                    If (\SRCM (ST01, "At least one symbol required", 0x1C))
                    {
                        ...
                        If (Local6)
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = YESN /* \_SB_.YESN */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = YESY /* \_SB_.YESY */
                        }
                        Else
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = NYES /* \_SB_.NYES */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = NONO /* \_SB_.NONO */
                        }
                    }
                    ...
                    If (\SRCM (ST01, "SATA Device Mode", 0x10))
                    {
                        ...
                        If (Local6)
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = ASTR /* \_SB_.ASTR */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = AHCI /* \_SB_.AHCI */
                        }
                        Else
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = ISTR /* \_SB_.ISTR */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = IDEC /* \_SB_.IDEC */
                        }
                    }

                    If (\SRCM (ST01, "Numlock state at boot", 0x15))
                    {
                        Local3 = 0x00
                        If (Local6)
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = ONST /* \_SB_.ONST */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = ONON /* \_SB_.ONON */
                        }
                        Else
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = OFST /* \_SB_.OFST */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = OFOF /* \_SB_.OFOF */
                        }
                    }
                    ...
                    If (Local3)
                    {
                        If (Local6)
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = ST08 /* \_SB_.ST08 */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = ST06 /* \_SB_.ST06 */
                        }
                        Else
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = ST09 /* \_SB_.ST09 */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = ST07 /* \_SB_.ST07 */
                        }
                    }
                }
                Else
                {
                    If ((Local1 == 0x02))
                    {
                        If (\SRCM (DerefOf (Index (DerefOf (Index (BISE, Arg0)), 0x0E)), CHGE, 
                            0x05))
                        {
                            Debug = "Policy Value = "
                            Debug = Local6
                            If ((Local6 == 0x01))
                            {
                                Index (DerefOf (Index (BISE, Arg0)), 0x01) = VSTR /* \_SB_.VSTR */
                                Index (DerefOf (Index (BISE, Arg0)), 0x0C) = VIEW /* \_SB_.VIEW */
                                Debug = "Policy = VIEW"
                            }

                            If ((Local6 == 0x02))
                            {
                                Index (DerefOf (Index (BISE, Arg0)), 0x01) = CSTR /* \_SB_.CSTR */
                                Index (DerefOf (Index (BISE, Arg0)), 0x0C) = CHGE /* \_SB_.CHGE */
                                Debug = "Policy = CHANGE"
                            }

                            If ((Local6 == 0x03))
                            {
                                Index (DerefOf (Index (BISE, Arg0)), 0x01) = HSTR /* \_SB_.HSTR */
                                Index (DerefOf (Index (BISE, Arg0)), 0x0C) = HIDE /* \_SB_.HIDE */
                                Debug = "Policy = HIDE"
                            }
                    ...
                    TM01 = DerefOf (Index (DerefOf (Index (BISE, Arg0)), 0x00))
                    If (\SRCM (TM01, "Wake on LAN", 0x0B))
                    {
                        Debug = "WOL values  "
                        ST03 = DerefOf (Index (WOLV, Local6))
                        BF2S = ST03 /* \_SB_.ST03 */
                        Index (DerefOf (Index (BISE, Arg0)), 0x0C) = BF2S /* \_SB_.BF2S */
                    }
                    ...
                    If (\SRCM (TM01, "Parallel Port Mode", 0x12))
                    {
                        ...
                        ST03 = DerefOf (Index (PPMD, Local6))
                        BF2S = ST03 /* \_SB_.ST03 */
                        Index (DerefOf (Index (BISE, Arg0)), 0x0C) = BF2S /* \_SB_.BF2S */
                        ST03 = DerefOf (Index (PPMS, Local6))
                        BF2S = ST03 /* \_SB_.ST03 */
                        Index (DerefOf (Index (BISE, Arg0)), 0x01) = BF2S /* \_SB_.BF2S */
                    }
                    ...
                    If (\SRCM (TM01, "Startup Menu Delay (Sec.)", 0x18))
                    {
                        ...
                        ST03 = DerefOf (Index (F12D, Local6))
                        BF2S = ST03 /* \_SB_.ST03 */
                        Index (DerefOf (Index (BISE, Arg0)), 0x0C) = BF2S /* \_SB_.BF2S */
                    }

                    If (\SRCM (TM01, "Express Boot Popup Delay(Sec)", 0x1D))
                    {
                        If ((Local6 > 0x07))
                        {
                            Local6 >>= 0x05
                        ...
                        ST03 = DerefOf (Index (BPPD, Local6))
                        BF2S = ST03 /* \_SB_.ST03 */
                        Index (DerefOf (Index (BISE, Arg0)), 0x0C) = BF2S /* \_SB_.BF2S */
                    }
                    ...
                    If (\SRCM (TM01, "Embedded Security Activation Policy", 0x23))
                    {
                        ...
                        If ((Local6 == 0x00))
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = F1PS /* \_SB_.F1PS */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = F1PV /* \_SB_.F1PV */
                        }

                        If ((Local6 == 0x01))
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = F1F2 /* \_SB_.F1F2 */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = F12V /* \_SB_.F12V */
                        }

                        If ((Local6 == 0x02))
                        {
                            Index (DerefOf (Index (BISE, Arg0)), 0x01) = NOPS /* \_SB_.NOPS */
                            Index (DerefOf (Index (BISE, Arg0)), 0x0C) = NOPR /* \_SB_.NOPR */
                        }
                    }

                    If (\SRCM (TM01, "Language", 0x08))
                    {
                        ST03 = DerefOf (Index (LANG, Local6))
                        BF2S = ST03 /* \_SB_.ST03 */
                        Index (DerefOf (Index (BISE, Arg0)), 0x0C) = BF2S /* \_SB_.BF2S */
                    }
                    ...
                    {
                        ST03 = DerefOf (Index (BLKB, Local6))
                        BF2S = ST03 /* \_SB_.ST03 */
                        Index (DerefOf (Index (BISE, Arg0)), 0x0C) = BF2S /* \_SB_.BF2S */
                    }
            ...
            Method (WQBD, 1, NotSerialized)
            {
                ...
                If ((Arg0 == 0x00))
                {
                    ...
                    Index (DerefOf (Index (BSSS, Arg0)), 0x0B) = ((STAT & 
                        0xF0) >> 0x04)
                }
                ...
                If ((Arg0 == 0x02))
                {
                    ...
                    Local6 = EVAL /* \EVAL */
                    Index (DerefOf (Index (BSSS, Arg0)), 0x0B) = Local6
                }
                ...
                If ((Arg0 == 0x0E))
                {
                    If ((STAT == 0x80))
                    {
                        Index (DerefOf (Index (BSSS, Arg0)), 0x04) = 0x00
                        BF2S = NOIN /* \_SB_.NOIN */
                    }
                    Else
                    {
                ...
                If ((Arg0 == 0x11))
                {
                    ...
                    Else
                    {
                        ...
                        {
                            Local0 = 0x00
                            WTB4 = DerefOf (Index (DSTS, Local0))
                            BF2S = WTB4 /* \_SB_.WTB4 */
                        }
                ...
                {
                    WTB2 = SVID /* \SVID */
                    CreateField (WTB2, 0x00, 0x30, CSID)
                ...
                If ((Arg0 == 0x1D))
                {
                    ...
                    Else
                    {
                        ...
                        WTB4 = DerefOf (Index (DSMD, Local5))
                        BF2S = WTB4 /* \_SB_.WTB4 */
                    }
                }

                Index (DerefOf (Index (BSSS, Arg0)), 0x01) = BF2S /* \_SB_.BF2S */
            ...
            Method (WQBE, 1, NotSerialized)
            {
                ...
                If ((Arg0 == 0x00))
                {
                    ...
                    Index (DerefOf (Index (BSOL, Arg0)), 0x0B) = ((STAT & 
                        0xF0) >> 0x04)
                    STAT &= 0x0F
                    WBOR = BORD /* \BORD */
                    CreateField (WBOR, 0x00, (0x08 * 0x08), CBOS)
                    While ((Local1 != 0x08))
                    {
                        Local4 = DerefOf (Index (WBOR, Local1))
                        If ((Local4 != 0xFF))
                        {
                            Local5 = 0x00
                            While ((Local5 != 0x08))
                            {
                                Local7 = DerefOf (Index (DerefOf (Index (RMBI, Local5)), 0x00))
                                If ((Local4 == Local7))
                                {
                                    BF01 = DerefOf (Index (DerefOf (Index (RMBI, Local5)), 0x01))
                                    BF2S = BF01 /* \_SB_.BF01 */
                                    Index (CRBI, Local6) = BF2S /* \_SB_.BF2S */
                                    Local6++
                                    Local5 = (0x08 - 0x01)
                                }
                    ...
                    While ((Local5 != 0x08))
                    {
                        BF01 = DerefOf (Index (CRBI, Local5))
                        BF2S = BF01 /* \_SB_.BF01 */
                        Index (DerefOf (Index (BSOL, 0x00)), Local0) = BF2S /* \_SB_.BF2S */
                        Local5++
                        Local0++
                    }
                    ...
                    While ((Local2 != 0x08))
                    {
                        BF01 = DerefOf (Index (CRBI, Local2))
                        Local5 = 0x00
                        While ((DerefOf (Index (BF01, Local5)) != 0x00))
                        {
                            Local3 = DerefOf (Index (BF01, Local5))
                            Index (BVAL, Local1) = Local3
                            Local5++
                            Local1++
                        }

                        Index (BVAL, Local1) = 0x2C
                        Local1++
                        Local2++
                    }
                    ...
                    BB2S = BVAL /* \_SB_.BVAL */
                    Index (DerefOf (Index (BSOL, 0x00)), 0x01) = BB2S /* \_SB_.BB2S */
                }
                ...
                If ((Arg0 == 0x01))
                {
                    ...
                    While ((Local1 != 0x02))
                    {
                        Local4 = DerefOf (Index (SUIP, Local1))
                        If ((Local4 != 0xFF))
                        {
                            Local5 = 0x00
                            While ((Local5 != 0x02))
                            {
                                Local7 = DerefOf (Index (DerefOf (Index (UEBL, Local5)), 0x00))
                                If ((Local4 == Local7))
                                {
                                    BF01 = DerefOf (Index (DerefOf (Index (UEBL, Local5)), 0x01))
                                    BF2S = BF01 /* \_SB_.BF01 */
                                    Index (CUBO, Local6) = BF2S /* \_SB_.BF2S */
                                    Local6++
                                    Local5 = (0x02 - 0x01)
                                }
                    ...
                    While ((Local5 != 0x02))
                    {
                        BF01 = DerefOf (Index (CUBO, Local5))
                        BF2S = BF01 /* \_SB_.BF01 */
                        Index (DerefOf (Index (BSOL, Arg0)), Local0) = BF2S /* \_SB_.BF2S */
                        Local5++
                        Local0++
                    }
                    ...
                    While ((Local2 != 0x02))
                    {
                        BF01 = DerefOf (Index (CUBO, Local2))
                        Local5 = 0x00
                        While ((DerefOf (Index (BF01, Local5)) != 0x00))
                        {
                            Local3 = DerefOf (Index (BF01, Local5))
                    ...
                    BB2S = BVAL /* \_SB_.BVAL */
                    Index (DerefOf (Index (BSOL, Arg0)), 0x01) = BB2S /* \_SB_.BB2S */
                }
            ...
            Method (PLOK, 1, NotSerialized)
            {
                ...
                If ((Arg0 == 0x00))
                {
                    While ((DerefOf (Index (OAPW, Local1)) != 0x00))
                    {
                        Local1++
                    }

                    While ((DerefOf (Index (NAPW, Local2)) != 0x00))
                    {
                        Local2++
                    }
            ...
            Method (GBID, 0, NotSerialized)
            {
                ...
                While ((Local4 != Local2))
                {
                    ...
                    While ((Local1 != 0x14))
                    {
                        Index (TEMP, Local1) = DerefOf (Index (BOIN, Local4))
                        If (((DerefOf (Index (BOIN, Local4)) == 0x2C) || (DerefOf (Index (
                            BOIN, Local4)) == 0x00)))
                        {
                            Local1 = 0x13
                        }
                    ...
                    If ((DerefOf (Index (BOIN, Local4)) != 0x00))
                    {
                        Local3 = FNID ()
                        If ((Local3 != 0xFF))
                        {
                            Index (BOID, Local6) = Local3
                        }
            ...
            Method (FNID, 0, NotSerialized)
            {
                ...
                If ((\SRCM (TEMP, "Notebook Upgrade Bay(UEFI)", 0x1A) || \SRCM (TEMP, " Notebook Upgrade Bay(UEFI)", SizeOf (STG0))))
                {
                    Local3 = 0x01
                }
                ...
                If ((\SRCM (TEMP, "Hard Drive(C:)", 0x0E) || \SRCM (TEMP, " Hard Drive(C:)", 0x0E)))
                {
                    Local3 = 0x02
                }
                ...
                If ((\SRCM (TEMP, "USB Hard Disk", 0x0D) || \SRCM (TEMP, " USB Hard Disk", SizeOf (STG0))))
                {
                    Local3 = 0x06
                }

                If ((\SRCM (TEMP, "Network Controller", 0x12) || \SRCM (TEMP, " Network Controller ", SizeOf (STG0))))
                {
                    Local3 = 0x07
                }
                ...
                If ((\SRCM (TEMP, "Dock Upgrade Bay", 0x10) || \SRCM (TEMP, " Dock Upgrade Bay ", 0x11)))
                {
                    Local3 = 0x0A
                }

                If ((\SRCM (TEMP, "External SATA Drive", 0x13) || \SRCM (TEMP, " External SATA Drive ", 0x15)))
                {
                    Local3 = 0x0B
                }
            ...
            Method (WQBF, 1, NotSerialized)
            {
                If ((Arg0 == 0x00))
                {
                    If ((ISSP () == 0x01))
                    {
                        Index (DerefOf (Index (BSPV, 0x00)), 0x10) = 0x01
                        Index (DerefOf (Index (BSPV, 0x00)), 0x11) = SPSF /* \SPSF */
                    }
                    Else
                    {
                        Index (DerefOf (Index (BSPV, 0x00)), 0x10) = 0x00
                        Index (DerefOf (Index (BSPV, 0x00)), 0x11) = 0xFFFFFFFF
                    }

                    \_SB.SSMI (0xEA7B, 0x00, 0x06, 0x00, 0x00)
                    Index (DerefOf (Index (BSPV, 0x00)), 0x0C) = PWDL /* \PWDL */
                }
                Else
                {
            ...
            {
                \_SB.SSMI (0xEA7B, 0x00, 0x06, 0x00, 0x00)
                Index (DerefOf (Index (BSIN, 0x00)), 0x0E) = PWDL /* \PWDL */
                If ((PWDL <= 0x09))
                {
                    Local2 = 0x01
                }
                ...
                Local3 = \ISTR (Local1, Local2)
                BF2S = Local3
                Index (DerefOf (Index (BSIN, Arg0)), 0x01) = BF2S /* \_SB_.BF2S */
            ...
            Method (WQBJ, 1, NotSerialized)
            {
                ...
                {
                    BF2S = USRN /* \USRN */
                    Index (DerefOf (Index (BUSR, Arg0)), 0x00) = BF2S /* \_SB_.BF2S */
                    Index (DerefOf (Index (BUSR, Arg0)), 0x11) = ROLE /* \ROLE */
                    CreateDWordField (HASH, 0x00, HSH1)
                    If ((HSH1 != 0x00))
                    {
                        Index (DerefOf (Index (BUSR, 0x00)), 0x10) = 0x01
                        If ((Arg0 == 0x00))
                        {
                            Index (DerefOf (Index (BUSR, 0x00)), 0x12) = SPSF /* \SPSF */
                        }
                        Else
                        {
                            Index (DerefOf (Index (BUSR, 0x00)), 0x12) = 0x01
                        }
                    }
                    Else
                    {
                        Index (DerefOf (Index (BUSR, 0x00)), 0x10) = 0x00
                    }
                }
                Else
                {
                    Index (DerefOf (Index (BUSR, Arg0)), 0x00) = NULL /* \_SB_.WMID.NULL */
                    Index (DerefOf (Index (BUSR, 0x00)), 0x10) = 0x00
                    Index (DerefOf (Index (BUSR, Arg0)), 0x11) = 0x00
                }
            ...
            Method (WMBA, 3, NotSerialized)
            {
                If ((Arg1 == 0x01))
                {
                    ...
                    While ((Local5 != Local4))
                    {
                        Index (ST01, Local6) = DerefOf (Index (Local0, Local2))
                        Local2++
                        Local5++
                        Local6++
                        Local2++
                    ...
                    Local5 = 0x00
                    Local6 = 0x00
                    Index (PCHG, 0x00) = 0x00
                    If ((\SRCM (ST01, "Boot Order Security Level", 0x19) || \SRCM (ST01, "UEFI Boot Order Security Level", 0x1C)))
                    {
                        Local5 = 0x00
                    }
                    Else
                    {
                        If ((\SRCM (ST01, "Boot Order", 0x0A) || \SRCM (ST01, "UEFI Boot Order", 0x0F)))
                        {
                            Local2--
                            Local4 += (DerefOf (Index (Local0, Local2)) * 0x0100)
                            Local2++
                            While ((Local5 != Local4))
                            {
                                Index (BOIN, Local6) = DerefOf (Index (Local0, Local2))
                                Local2++
                                Local5++
                                Local6++
                                Local2++
                    ...
                    If (\SRCM (ST01, "Setup Password", 0x0E))
                    {
                        While ((Local5 != Local4))
                        {
                            Index (PCBF, Local6) = DerefOf (Index (Local0, Local2))
                            Local2++
                            Local5++
                            Local6++
                        }
                    ...
                    Local5 = 0x00
                    Local6 = 0x00
                    Index (VFSZ, 0x00) = Local4
                    While ((Local5 != Local4))
                    {
                        Index (ST02, Local6) = DerefOf (Index (Local0, Local2))
                        Local2++
                        Local5++
                        Local6++
                        Local2++
                    ...
                    Local4 = 0x00
                    Local2 = 0x00
                    If (\SRCM (ST01, "Synchronize settings", 0x14))
                    {
                        Return (0x00)
                    }
                    ...
                    While ((Local5 != Local4))
                    {
                        ST14 = DerefOf (Index (DerefOf (Index (BISE, Local4)), 0x00))
                    ...
                    If (\SRCM (ST01, "Password Minimum Length", 0x17))
                    {
                        ...
                        If ((DerefOf (Index (VFSZ, 0x00)) == 0x04))
                        {
                    ...
                    If ((Local2 == 0x00))
                    {
                        ...
                        While ((Local5 != Local4))
                        {
                            ST14 = DerefOf (Index (DerefOf (Index (BSSS, Local4)), 0x00))
                    ...
                    If ((Local2 == 0x01))
                    {
                        ...
                        If ((DerefOf (Index (PCHG, 0x00)) == 0x01))
                        {
                        ...
                        Else
                        {
                            ...
                            Else
                            {
                                ...
                                If (\SRCM (ST01, "Express Boot Popup Delay(Sec)", 0x1D))
                                {
                                    If (\SRCM (ST02, "0", 0x01))
                                    {
                                        Local6 = 0x00
                    ...
                    If ((Local2 == 0x02))
                    {
                        ...
                        If (\SRCM (ST01, "Asset Tracking Number", SizeOf (ST01)))
                        {
                            ...
                            While ((Local5 != Local1))
                            {
                                If ((DerefOf (Index (ST02, Local4)) == 0x00))
                                {
                                    Local5 = SizeOf (ST02)
                                    Local5--
                                }
                        ...
                        If (\SRCM (ST01, "Ownership Tag", SizeOf (ST01)))
                        {
                            ...
                            While ((Local1 != 0x50))
                            {
                                Index (WONT, Local1) = DerefOf (Index (ST02, Local1))
                                Local1++
                            }
                    ...
                    If ((Local2 == 0x03))
                    {
                        ...
                        While ((Local2 < 0x64))
                        {
                            ...
                            While ((Local6 < 0x08))
                            {
                                If ((DerefOf (Index (BOID, Local2)) == DerefOf (Index (WSIP, Local5))))
                                {
                                    Index (DVAL, 0x00) = 0x01
                                    Local6 = (0x08 - 0x01)
                                }
                            ...
                            Local5--
                            If ((DerefOf (Index (DVAL, 0x00)) == 0x01))
                            {
                                Local4 = Local5
                                Local4--
                                While ((Local5 > Local3))
                                {
                                    Index (WSIP, Local5) = DerefOf (Index (WSIP, Local4))
                                    Local5--
                                    Local4--
                                }

                                Index (WSIP, Local3) = DerefOf (Index (BOID, Local2))
                                Local3++
                            }
                    ...
                    If ((Local2 == 0x08))
                    {
                        ...
                        While ((Local2 < 0x64))
                        {
                            ...
                            While ((Local6 < 0x02))
                            {
                                If ((DerefOf (Index (BOID, Local2)) == DerefOf (Index (SUIP, Local5))))
                                {
                                    Index (DVAL, 0x00) = 0x01
                                    Local6 = (0x02 - 0x01)
                                }
                            ...
                            If ((DerefOf (Index (DVAL, 0x00)) == 0x01))
                            {
                                ...
                                While ((Local5 > Local3))
                                {
                                    Index (SUIP, Local5) = DerefOf (Index (SUIP, Local4))
                                    Local5--
                                    Local4--
                                }

                                Index (SUIP, Local3) = DerefOf (Index (BOID, Local2))
                                Local3++
                            }
                    ...
                    If ((DerefOf (Index (FLAG, 0x00)) == 0x05))
                    {
                        STAT = 0x05
                        Return (STAT) /* \STAT */
                    }
                ...
                If ((Arg1 == 0x02))
                {
                    ...
                    If ((ISSP () == 0x01))
                    {
                        ...
                        While ((Local5 != Local4))
                        {
                            Index (STG1, Local6) = DerefOf (Index (Local0, Local2))
                            Local2++
                            Local5++
                            Local6++
                            Local2++
            ...
            Method (IBUF, 0, NotSerialized)
            {
                ...
                {
                    Index (WSPS, Local3) = 0x00
                    Index (WNWP, Local3) = 0x00
                    Index (WPPS, Local3) = 0x00
                    Index (WNPP, Local3) = 0x00
                    Local3++
                }
            ...
            Method (WMAC, 3, NotSerialized)
            {
                If ((Arg1 == 0x01))
                {
                    ...
                    While ((Local5 != Local4))
                    {
                        Index (BUFU, Local6) = DerefOf (Index (Local0, Local2))
                        Local2++
                        Local5++
                        Local6++
                        Local2++
            ...
            Method (STLN, 1, NotSerialized)
            {
                ...
                {
                    Local2 = DerefOf (Index (Local0, Local1))
                    If ((Local2 == 0x00))
                    {
                        Local1 = SizeOf (Local0)
                    }
            ...
            Method (WGDD, 0, NotSerialized)
            {
                ...
                Index (DerefOf (Index (Local0, 0x02)), 0x00) = Local2
                Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x01
                Index (DerefOf (Index (Local0, 0x02)), 0x02) = 0x01
                Return (Local0)
            }
            ...
            Method (WGWS, 0, NotSerialized)
            {
                Local2 = Package (0x03) {}
                Index (Local2, 0x00) = 0x00
                Index (Local2, 0x01) = 0x50
                Index (Local2, 0x02) = WLDA /* \WLDA */
                Return (Local2)
            }
            ...
            Method (WGBN, 0, NotSerialized)
            {
                ...
                Concatenate (Local1, Buffer (0x0A)
                    {
                        /* 0000 */  0xFF, 0xFF, 0x9A, 0x21, 0x9B, 0x21, 0xA9, 0x21,  /* ...!.!.! */
                        /* 0008 */  0x00, 0x00                                       /* .. */
                    }, Local2)
                Local0 = SizeOf (Local2)
                Local3 = Package (0x03) {}
                Index (Local3, 0x00) = 0x00
                Index (Local3, 0x01) = Local0
                Index (Local3, 0x02) = Local2
                Return (Local3)
            }
            ...
            Method (GHKS, 0, NotSerialized)
            {
                ...
                Index (DerefOf (Index (Local0, 0x02)), 0x00) = \_SB.PCI0.LPCB.EC0.GSHK ()
                Return (Local0)
            }
            ...
            Method (HKFR, 0, NotSerialized)
            {
                ...
                Local2 = ASMB /* \ASMB */
                Local1 = DerefOf (Index (Local2, 0x00))
                If ((Local1 == 0x0D))
                {
                    Index (DerefOf (Index (Local0, 0x02)), 0x00) = 0x31
                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x01
                }
                ...
                If ((Local1 == 0x04))
                {
                    ...
                    VGDD (0x00)
                    Index (DerefOf (Index (Local0, 0x02)), 0x00) = 0xAE
                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x01
                    Local3 = FUF4 (WDGN)
                    Local4 = FUF4 (WDSA)
                    Index (DerefOf (Index (Local0, 0x02)), 0x02) = Local3
                    Index (DerefOf (Index (Local0, 0x02)), 0x03) = Local4
                ...
                If ((Local1 == 0x08))
                {
                    Index (DerefOf (Index (Local0, 0x02)), 0x00) = 0x9E
                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x01
                }
                ...
                If (((Local1 == 0x09) || (Local1 == 0x0A)))
                {
                    ...
                    \_GPE.VBRE (Local1)
                    Index (DerefOf (Index (Local0, 0x02)), 0x00) = (0xAD + Local1)
                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x01
                    If ((WDPE & 0x40))
                    {
                        Wait (\_SB.BEVT, 0x10)
                    ...
                    Index (DerefOf (Index (Local0, 0x02)), 0x02) = BRID /* \BRID */
                    Index (DerefOf (Index (Local0, 0x02)), 0x03) = DerefOf (Index (Local2, 
                        0x03))
                }
            ...
            Method (WGBV, 0, NotSerialized)
            {
                ...
                If ((Local1 == 0x01))
                {
                    Index (DerefOf (Index (Local0, 0x02)), 0x00) = 0x9B
                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x21
                }

                If ((Local1 == 0x02))
                {
                    Index (DerefOf (Index (Local0, 0x02)), 0x00) = 0x9A
                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x21
                }
                ...
                If ((Local1 == 0x03))
                {
                    ...
                    Index (DerefOf (Index (Local0, 0x02)), 0x00) = 0xA9
                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x21
                    Index (DerefOf (Index (Local0, 0x02)), 0x02) = Local2
                    Index (DerefOf (Index (Local0, 0x02)), 0x03) = 0x00
                }
            ...
            Method (GSAS, 0, NotSerialized)
            {
                ...
                Local1 = \_SB.PCI0.LPCB.EC0.GPID ()
                Local1 += 0x01
                Index (DerefOf (Index (Local0, 0x02)), 0x00) = Local1
                Return (Local0)
            }
                    ...
                    If (\_SB.PCI0.LPCB.EC0.ECRG)
                    {
                        ...
                        Else
                        {
                            ...
                            If ((EBX == 0x00))
                            {
                                ...
                                While ((Local2 < 0x0C))
                                {
                                    Index (Local0, (Local2 + 0x04)) = DerefOf (Index (Local1, Local2
                                        ))
                                    Local2++
                                }
                            ...
                            Else
                            {
                                ...
                                Else
                                {
                                    ...
                                    If ((BV1 < 0x36B0))
                                    {
                                        If (((BV1 > 0x3390) || (BV1 < 0x2DB4)))
                                        {
                                            Local1 = 0x01
                                        }

                                        If (((BV2 > 0x3390) || (BV2 < 0x2DB4)))
                                        {
                                            Local1 = 0x01
                                        }
                                    ...
                                    Else
                                    {
                                        If (((BV1 > 0x445C) || (BV1 < 0x3D54)))
                                        {
                                            Local1 = 0x01
                                        }

                                        If (((BV2 > 0x445C) || (BV2 < 0x3D54)))
                                        {
                                            Local1 = 0x01
                                        }
            ...
            {
                \_SB.SSMI (0xEA75, 0x02, 0x33, 0x574D4953, 0x00)
                Return (WFDA ())
            }
            ...
            Name (_WDG, Buffer (0x0118)
            {
                ...
                /* 0070 */  0x09, 0xE7, 0x51, 0x33, 0x42, 0x43, 0xAA, 0x00,  /* ..Q3BC.. */
                ...
                /* 0110 */  0x82, 0xF8, 0x21, 0xF3, 0x42, 0x4A, 0x05, 0x00   /* ..!.BJ.. */
            })
            ...
            Method (_WED, 1, NotSerialized)  // _Wxx: Wake Event
            {
                If ((Arg0 == 0xA0))
                {
                    If ((DerefOf (Index (ETYP, 0x00)) == 0x00))
                    {
                        BF2S = ST01 /* \_SB_.ST01 */
                        Index (DerefOf (Index (EVNT, 0x00)), 0x01) = BF2S /* \_SB_.BF2S */
                        Return (DerefOf (Index (EVNT, 0x00)))
                    }

                    If ((DerefOf (Index (ETYP, 0x00)) == 0x01))
                    {
    ...
    Method (\_SB.HODM, 3, NotSerialized)
    {
        ...
        If ((OCTY == 0x01))
        {
            If ((ODSI == 0x1C))
            {
                CreateDWordField (Arg2, 0x10, IEAX)
                CreateWordField (Arg2, 0x10, INAX)
                CreateByteField (Arg2, 0x10, INAL)
                CreateByteField (Arg2, 0x11, INAH)
                CreateDWordField (Arg2, 0x14, IEBX)
                CreateWordField (Arg2, 0x14, INBX)
                CreateByteField (Arg2, 0x14, INBL)
                CreateByteField (Arg2, 0x15, INBH)
                CreateDWordField (Arg2, 0x18, IECX)
                CreateWordField (Arg2, 0x18, INCX)
                CreateByteField (Arg2, 0x18, INCL)
                CreateByteField (Arg2, 0x19, INCH)
                CreateDWordField (Arg2, 0x1C, IEDX)
                CreateWordField (Arg2, 0x1C, INDX)
                CreateByteField (Arg2, 0x1C, INDL)
                CreateByteField (Arg2, 0x1D, INDH)
                CreateDWordField (Arg2, 0x20, CFGS)
                CreateDWordField (Arg2, 0x24, IESI)
                CreateWordField (Arg2, 0x24, INSI)
                CreateDWordField (Arg2, 0x28, IEDI)
                CreateWordField (Arg2, 0x28, INDI)
                Local0 = Package (0x03)
                    {
                        0x00, 
                        0x1C, 
                ...
                Index (DerefOf (Index (Local0, 0x02)), 0x10) = 0x01
                Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x86
                If ((IEAX == 0x9611))
                {
                    If ((INBL == 0x2B))
                    {
                        If ((INBH == 0x00))
                        {
                            If ((INCL == 0x10))
                            {
                                Index (DerefOf (Index (Local0, 0x02)), 0x0C) = 0x02
                                Index (DerefOf (Index (Local0, 0x02)), 0x10) = 0x00
                                Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x00
                            }

                            If ((INCL == 0x11))
                            {
                                Index (DerefOf (Index (Local0, 0x02)), 0x0C) = 0x01
                                Index (DerefOf (Index (Local0, 0x02)), 0x10) = 0x00
                                Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x00
                            }
                            ...
                            If ((INCL == 0x20))
                            {
                                ...
                                {
                                    Local1 = (CTV1 >> 0x06)
                                    Index (DerefOf (Index (Local0, 0x02)), 0x0C) = Local1
                                    Index (DerefOf (Index (Local0, 0x02)), 0x0D) = 0x80
                                    Index (DerefOf (Index (Local0, 0x02)), 0x10) = 0x00
                                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x00
                                }
                            ...
                            If ((INCL == 0x21))
                            {
                                If ((INCH == 0x00))
                                {
                                    ...
                                    Local1 *= 0x02
                                    Index (DerefOf (Index (Local0, 0x02)), 0x0C) = Local1
                                    Index (DerefOf (Index (Local0, 0x02)), 0x0D) = 0x00
                                    Index (DerefOf (Index (Local0, 0x02)), 0x10) = 0x00
                                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x00
                                }
                            }
                        ...
                        If ((INBH == 0x02))
                        {
                            If ((INCH == 0x00))
                            {
                                If ((INCL >= 0x00))
                                {
                                    Divide (INCL, 0x04, Local2, Local1)
                                    If (((Local1 <= 0x22) && (Local1 >= 0x19)))
                                    {
                                        Local2 = (Local1 - 0x19)
                                        Local2 *= 0x03
                                        Local2 -= 0x64
                                    ...
                                    Sleep (0x3C)
                                    \_SB.PCI0.LPCB.EC0.TENA = 0x00
                                    Sleep (0x3C)
                                    \_SB.PCI0.LPCB.EC0.CFAN = Local2
                                    Index (DerefOf (Index (Local0, 0x02)), 0x10) = 0x00
                                    Index (DerefOf (Index (Local0, 0x02)), 0x01) = 0x00
                                }
                            }
    ...
    Device (PTID)
    {
        ...
        Name (TMPV, Package (0x1E)
        {
            0x03, 
            "0-EXTZ-External/Remote 1", 
            0x80000000, 
            0x03, 
            "1-EX2Z-External/Remote 2", 
            0x80000000, 
            0x03, 
            "2-PWMZ-PWM from EC", 
            0x80000000, 
            ...
            0x80000000, 
            0x01, 
            "4-GFXZ-Graphics via driver", 
            0x80000000, 
            0x03, 
            "5-BATZ-Battery", 
            0x80000000, 
            0x01, 
            "6-EGXZ-Graphics via EC", 
            0x80000000, 
            0x00, 
            "7-CPUZ-CPU PECI reading from PCH", 
            0x80000000, 
            0x05, 
            "8-MCHZ-MCH DTS from PCH", 
            0x80000000, 
            0x05, 
            "9-PCHZ-PCH DTS from PCH", 
            0x80000000
        })
        ...
        {
            Index (TMPV, 0x02) = \_TZ.EXTZ._TMP ()
            Index (TMPV, 0x05) = \_TZ.EX2Z._TMP ()
            Index (TMPV, 0x08) = \_TZ.PWMZ._TMP ()
            Index (TMPV, 0x0B) = \_TZ.LOCZ._TMP ()
            Index (TMPV, 0x0E) = \_TZ.GFXZ._TMP ()
            Index (TMPV, 0x11) = \_TZ.BATZ._TMP ()
            Index (TMPV, 0x14) = \_TZ.EGXZ._TMP ()
            Index (TMPV, 0x17) = \_TZ.CPUZ._TMP ()
            Index (TMPV, 0x1A) = \_TZ.MCHZ._TMP ()
            Index (TMPV, 0x1D) = \_TZ.PCHZ._TMP ()
            Return (TMPV) /* \PTID.TMPV */
        }

        Method (PSDD, 0, NotSerialized)
        {
            Index (PWRV, 0x02) = 0x03E8
            Return (PWRV) /* \PTID.PWRV */
        }

        Method (OSDD, 0, NotSerialized)
        {
            Index (OSDV, 0x03) = \_TZ.GFSD ()
    ...
    If (ILUX)
    {
        Method (\_SB.PCI0.RP06.NIC._EJ0, 1, NotSerialized)  // _EJx: Eject Device
        {
            EJ0 ()
        }
    }

    Method (\_GPE._L1A, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
    {
        \_GPE.L1A ()
    }
